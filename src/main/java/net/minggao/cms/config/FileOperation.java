...
//	private static String template_path = PropertyConstants.getPropertiesKey("template.path");
	private static String template_path = getSite();

//	public static void main(String[] args) throws IOException {
//		FileOperation.creatTxtFile("你好");
...
//	}
	...
	public static boolean creatTxtFile(String name) throws IOException {
		boolean flag = false;
		template_path  = getSite();
		filenameTemp = template_path + name + ".ftl";
