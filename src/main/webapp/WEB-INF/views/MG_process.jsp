...
<div class="MG-layout MG-layout-admin">
    ...
    <section class="MG-body">
        <div class="page-title">
            <h1 class="title-left">流程管理</h1>

            <input id="ImgName" type="text" placeholder="流程名称">
    ...
    <div id="popContainer" class="MG-modal">
        ...
        <div class="MG-modal-body" >
            <table class="table-dialog " cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <label>流程名称<span>*</span>:</label>
                        <input id="processName" type="text" placeholder="" maxlength="50">
...
<script>
    ...
    function updatetable(testType){ //对列表的数据进行更新的函数
        ...
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath}/Process/getProcessList",
            data:{
            ...
            success:function(result){
                ...
                $("#livetable").empty();
                var xx=new Array("processName","processId");
                var htmltable=getMessage(result.processList,xx,2);
    ...
    function post(id){
        ...
        if($("#processName").val().indexOf("&nbsp")>-1){
            alert("非法字符！");
        ...
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath}/Process/setProcessMessage",
            data:{
    ...
    function upda(id){
        ...
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath}/Process/getProcessSingle",
            data:{
                processId:id
            },
            success:function(result){
    ...
    function del(id){
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath}/Process/deleteMessage",
            data:{
                processId:id
            },
            success:function(result){
    ...
    function set(id){
        window.location.href ="${pageContext.request.contextPath}/Process/updatePage?updateid="+id;
    }
